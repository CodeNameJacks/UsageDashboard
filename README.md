...
-	Open another terminal session and navigate to the `frontend` folder. Enter `npm install` to install the dependencies. Then enter `npm start` to run the application.
